...
const FOUNDER_DEMO: People[] = [
  {
    ...
    name: `Niamh O'Shea`,
    job: 'Co-founder and Chief Executive',
    avatar: '/icons/How we work 9.png',
  },
  {
    id: '2',
    name: `Danien Jame`,
    job: 'Co-founder and Chief Executive',
    avatar: '/icons/How we work 2.png',
  },
  {
    id: '3',
    name: `Danien Jame`,
    job: 'Co-founder and Chief Executive',
    avatar: '/icons/How we work 3.png',
  },
  {
    id: '4',
    name: `Danien Jame`,
    job: 'Co-founder and Chief Executive',
    avatar: '/icons/How we work 5.png',
  },
  
  {
    ...
    name: `Orla Dwyer`,
    job: 'Co-founder, Chairman',
    avatar: '/icons/How we work 6.png',
  },
  {
    id: '6',
    name: `Dara Frazier`,
    job: 'Co-Founder, Chief Strategy Officer',
    avatar: '/icons/How we work 4.png',
  },
  {
    id: '7',
    name: `Danien Jame`,
    job: 'Co-founder and Chief Executive',
    avatar: '/icons/How we work 10.png',
  },
  {
    id: '8',
    name: `Danien Jame`,
    job: 'Co-founder and Chief Executive',
    avatar: '/icons/How we work 1.png',
  },
      ...
      <div className="grid sm:grid-cols-2 gap-x-5 gap-y-8 lg:grid-cols-4 xl:gap-x-8">
        {FOUNDER_DEMO.map((item) => (
          <div key={item.id} className="max-w-sm">
            ...
            {/* {/ Optional: Uncomment below to show name and job /} */}
            {/* <h3 className="text-lg font-semibold text-neutral-900 mt-4 md:text-xl dark:text-neutral-200">
              {item.name}
            </h3>
            <span className="block text-sm text-neutral-500 sm:text-base dark:text-neutral-400">
